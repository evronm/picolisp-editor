...
function! s:PicoLisp()
  ...
  hi def hlLevel5 ctermfg=45		guifg=springgreen1 cterm=bold gui=bold
  hi def hlLevel6 ctermfg=38	guifg=cyan1 cterm=bold gui=bold
  hi def hlLevel7 ctermfg=75	guifg=lightblue cterm=bold gui=bold
  hi def hlLevel8 ctermfg=200	guifg=magenta1 cterm=bold gui=bold
  hi def hlLevel9 ctermfg=201	guifg=magenta2 cterm=bold gui=bold
